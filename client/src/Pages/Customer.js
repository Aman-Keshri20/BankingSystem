...
function Customer() {
  ...
  const handleTransaction = async () => {
    ...
    const transaction_type =
      modalType === 'deposit' ? 'deposit' : 'withdrawal';

    await api.handleTransaction(user_id, transaction_type, numAmount, token);
    await fetchTransactionData();
    closeModal();
  };
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="modal-content">
              <div className="balance-info">Available Balance: ₹{balance}</div>
